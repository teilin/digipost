...
public class WebClient {
	...
	public boolean authenticate() {
		...
		try {
			...
			// keyValue.add(new BasicNameValuePair("foedselsnummer",
			// user.getPID()));
			// keyValue.add(new BasicNameValuePair("passord",
			// user.getPassword()));
	...
	public JSONObject getJSONFromURI(String uri) {
		...
		String jString = getStringFromURI(uri);
		try {
	...
	private JSONArray getJSONArrayFromURI(String uri) {
		String jString = getStringFromURI(uri);
		try {
